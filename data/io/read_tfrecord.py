...
def next_batch(dataset_name, batch_size, shortside_len, is_training):
    ...
    #
    # if is_training:
    #     pattern = os.path.join('/home/qisens/2020.3~/R2CNN_Faster-RCNN_Tensorflow/bk/data/tfrecord', dataset_name + '_train*')
    # else:
    #     pattern = os.path.join('/home/qisens/2020.3~/R2CNN_Faster-RCNN_Tensorflow/bk/data/tfrecord', dataset_name + '_test*')
    if is_training:
    ...
    img_name, img, gtboxes_and_label, num_obs = read_and_prepocess_single_img(filename_queue, shortside_len, is_training=is_training)
