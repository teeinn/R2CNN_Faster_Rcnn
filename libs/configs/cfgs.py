...
MOMENTUM = 0.9
LR = 0.0003  # 0.0003
DECAY_STEP = [100000, 150000, 220000]
# DECAY_STEP = [50000, 100000] # 30001 resume
# DECAY_STEP = [100000, 168000, 198000] # 148002 resume
...
USE_DROPOUT = False
KEEP_PROB = 1.0
SHOW_SCORE_THRSHOLD = 0.01 #0.5  # only show in tensorboard 0.01
